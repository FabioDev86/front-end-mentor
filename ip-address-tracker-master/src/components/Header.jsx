    ...
    return(
        <div className='flex flex-col items-center gap-10 p-[4rem]'> 
            ...
            <form className='flex flex-col' onSubmit={handleSubmit}>                
                <div className='flex'>
                    <input id="ip_address" onFocus={() => {setFocus(true)}} onBlur={() => {setFocus(false)}} onChange={handleChange} placeholder="Search for any IP address or domain" className={'rounded-l-lg p-3 w-[30rem] focus:outline-none ' + (valid ? '' : 'focus:bg-red-400 focus:placeholder-gray-800')}></input>
